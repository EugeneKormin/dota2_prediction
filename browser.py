...
class Browser(object):
    ...
    def find_element(self, how, object_):
        if how == "id":
            found_object = self.browser.find_element_by_id(object_)
        elif how == "xpath":
            found_object = self.browser.find_element_by_xpath(xpath=object_)
        elif how == "name":
            found_object = self.browser.find_element_by_name(name=object_)
        return found_object
    ...
    def get_html_from_match_id(self):
        browser = Browser()
        ...
        input_box.send_keys(str(5960390171))
